...
from modules.tierlists.migrations import DEFAULT_TIERS_JSON
from modules.tierlists.messages import (
...
from modules.tierlists.models import SessionStatus, TemplateVisibility, TierSession, TierTemplate, TierTemplateItem, TierTemplateVersion
from modules.tierlists.repository_utils import normalize_slug
from modules.tierlists.session_renderer import SessionRenderSnapshot, TierSessionRenderer
from modules.tierlists.session_repository import TierSessionRepository
from modules.tierlists.template_repository import TierTemplateRepository
...
class TierTemplateCog(commands.Cog):
    ...
    async def build_editor_embed_and_view(
        ...
        *,
        ...
        from modules.tierlists.ui.views import TemplateEditorView
    ...
    def register_dynamic_items(self) -> None:
        if not hasattr(self.bot, "add_dynamic_items"):
            ...
            return
        from modules.tierlists.ui.dynamic_items import TierSessionActionDynamicItem
    ...
    async def build_session_view(self, session_id: str, *, disabled: bool = False) -> discord.ui.View:
        from modules.tierlists.ui.session_views import TierSessionView
