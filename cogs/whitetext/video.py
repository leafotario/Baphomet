...
from .errors import FFmpegNotFoundError, InvalidVideoError, OutputTooLargeError, VideoProcessingError, VideoTooLargeError
from .layout import CaptionStyle


if TYPE_CHECKING:
    from .processor import WhiteTextProcessorConfig
...
def process_video_bytes_to_captioned_gif(
    ...
    from .processor import WhiteTextProcessorConfig, process_gif_bytes
