...
def main():
    ...
    tierlist_replacements = [
        (r'from \.database import', r'from modules.media_assets.database import'),
        (r'from \.migrations import', r'from modules.tierlists.migrations import'),
        (r'from \.models import', r'from modules.media_assets.models import'),
        (r'from \.asset_repository import', r'from modules.media_assets.asset_repository import'),
        ...
        (r'from \.repository_utils import', r'from modules.media_assets.repository_utils import'),
        ...
        (r'from \.downloads import', r'from modules.media_assets.downloads import'),
        (r'from \.exceptions import', r'from modules.media_assets.exceptions import'),
